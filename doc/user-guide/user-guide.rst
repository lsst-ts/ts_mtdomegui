...
Some of commands would need you to select the input clearly.
...
Some of commands would need you to open the related selection widget to select the items.
...
Moreover, **NORMAL** mode allows to go to full performance of the dome.
...
It shows the current power and related realtime chart on the top.
