...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        # Control tabs
        tabs = [
            TabCommand("Command", self.model),
            TabUtility("Utility", self.model),
            TabInterlock("Interlock", self.model),
            TabSensorFixed("Sensor (Fixed Part)", self.model),
            TabSensorRotating("Sensor (Rotating Part)", self.model),
            TabAzimuth("Azimuth", self.model),
            TabElevation("Elevation (Light/Wind Screen)", self.model),
            TabApertureShutter("Aperture Shutter", self.model),
            TabLouver("Louver", self.model),
            TabThermalSystem("Thermal System", self.model),
            TabRearAccessDoor("Rear Access Door", self.model),
            TabCalibration("Calibration Screen", self.model),
        ]
        ...
        self.setWindowTitle("Dome Control")
    ...
    def _get_log_file_name(self, default_log_dir: str = "/rubin/dome/log") -> pathlib.Path:
        """Get the log file name.

        Parameters
        ----------
        default_log_dir : `str`, optional
            Default log directory. (the default is "/rubin/dome/log")
    ...
    def _add_tool_bar(self) -> None:
        ...
        action_connect.setToolTip("Connect to the dome controller")
